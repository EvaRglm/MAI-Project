...
if __name__ == "__main__":
    image_folder = 'DATASET/flickr30k_images/test'
    sentence_folder = os.path.join('DATASET/flickr30k', 'Sentences')
    annotation_folder = os.path.join('DATASET/flickr30k', 'Annotations')
